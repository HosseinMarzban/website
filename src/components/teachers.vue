              ...
              <li 
                ...
                <el-tooltip 
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="nofollow">
                    <i :class="['fab', 'fa-'+ o.icon]"/>
                  </a>
                </el-tooltip>
              </li>
            </ul><!-- End - Caption/Social/list -->
          </div><!-- End - Caption/lower -->
        </div><!-- End - Brick/Caption -->
      </div><!-- End - Columns/Brick -->
    </el-col><!-- End - Columns -->
  </el-row>
</template>
